...
import { ActionType, TimelineType } from "../core/DragonBones";
import { DisplayData, GeometryData, ImageDisplayData, MeshDisplayData, PathDisplayData } from "../model/DisplayData";
...
import { BoundingBoxData, PolygonBoundingBoxData } from "../model/BoundingBoxData";
import { SkinData } from "../model/SkinData";
import { ConstraintData } from "../model/ConstraintData";
export declare const enum FrameValueType {
    Step = 0,
    Int = 1,
    Float = 2
}
...
export declare class ActionFrame {
    frameStart: number;
